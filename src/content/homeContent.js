export const homeContent = {
  ...
  "brand": {
    "abbr": "AHS",
    "logoSrc": "assets/img/ahs_logo_xs.png"
  },
  "applyNow": {
    "label": "Apply Now",
    "href": "#!"
  ...
  "hero": {
    "titleTamil": "A Journey of Language, Heritage & Knowledge",
    "titleEnglish": "Nurturing young minds through the richness of Tamil culture\n                    while preparing them for a global future. Join us in\n                    celebrating tradition and excellence in education.",
    "description": "",
    "primaryCta": {
  ...
  "academics": {
    ...
    "description": "Comprehensive programs designed to nurture Tamil language skills and\n            cultural knowledge while providing world-class education.",
    "services": [
      {
        "number": "01",
        "title": "Pre-Primary",
  ...
  "activities": {
    "heading": "Immersive Cultural Experience",
    "description": "Students engage in traditional Tamil arts, festivals, and activities\n            that connect them to their rich cultural heritage.",
    "items": [
      {
        "title": "Bharatanatyam",
        "desc": null,
        "img": "assets/img/Bharatanatyam.jpg"
      },
      {
        "title": "Silambam",
        "desc": null,
        "img": "assets/img/Silambam.jpg"
      },
      {
        "title": "Pongal Festival",
        "desc": null,
        "img": "assets/img/Pongal-Festival.jpg"
      },
      {
        "title": "Tamil Debate",
        "desc": null,
        "img": "assets/img/tamil-debate.jpg"
      },
      {
        "title": "Music & Arts",
        "desc": null,
        "img": "assets/img/Music-Arts.jpg"
      },
      {
        "title": "Cultural Events",
        "desc": null,
        "img": "assets/img/Cultural-Events.jpg"
      }
    ]
  },
  "gallery": {
    "heading": "School Life Gallery",
    "description": "A glimpse into daily life at Tamil Heritage School - where tradition\n            meets education.",
    "items": [
      {
  ...
  "contact": {
    "heading": "Contact Us",
    "description": "Have questions about admissions or our programs? We'd love to hear\n              from you.",
    "infoItems": [
      {
        "icon": "bi bi-geo-alt",
        "label": "Address",
